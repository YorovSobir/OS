...
//     char buf[10] = "Hello ";
//     for (int i = 0; i < 10; ++i){
//         // snprintf(dirname, 10, "./%d", i);
//         dirname[2] = i + '0';
//         mkdir(dirname);
//         // snprintf(fname, 10, "./%d/%d%d.f", i, i, i);
//         fname[2] = i + '0';
//         fname[3] = '/';
//         fname[4] = i + '0';
//         fname[5] = '.';
//         fname[6] = 'f';
//         int fd = open(fname, F_WRITE);
//         // snprintf(buf, 10, "Hello %d%d", i, i);
//         buf[6] = i + '0';
...
//     for (int i = 0; i < 10; ++i){
//         // snprintf(fname, 9, "./%d/%d%d.f", i, i, i);
//         fname[2] = i + '0';
//         fname[3] = '/';
//         fname[4] = i + '0';
//         fname[5] = '.';
//         fname[6] = 'f';
//         int fd = open(fname, F_READ);
//         read(fd, buf, 8);
//         printf("%s\n", buf);
//         close(fd);
//     }
//     printf("readdir ./\n");
//     node_t *root = get_root()->child;
//     while (root != NULL){
//         root = readdir(root);
//     }
//     printf("file system\n");
...
void main(void *bootstrap_info)
{
	...
	add_initramfs_range(bootstrap_info);
